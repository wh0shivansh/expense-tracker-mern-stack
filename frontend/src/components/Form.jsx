...
const Form = () => {
    ...
    return (
        <div className='form max-w-sm mx-auto w-96'>
            <br />
            <h1 className='font-bold pb-4 text-xl add-transaction'>Add Transaction</h1>

            <form id='form' onSubmit={handleSubmit(onSubmit)}>
                <div className="grid gap-4">
                    <div className="input-group">
                        <input type="text" className='form-input' {...register('name')} placeholder='Salary, House, Rent, SIP' />
                    </div>
